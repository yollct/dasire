...
echo "step 3 of 6: Pseudoaligning with kallisto"
...
echo "step 4 of 6: Quantifying exons with DEXSeq and AS Events with Majiq"
...
echo "step 5 of 6: DESeq, DEXSeq and IsoformSwitchAnalyzeR in R"
